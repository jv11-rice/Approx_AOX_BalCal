...
function varargout = Approx_AOX_GUI(varargin)
% APPROX_AOX_GUI MATLAB code for Approx_AOX_GUI.fig
%      APPROX_AOX_GUI, by itself, creates a new APPROX_AOX_GUI or raises the existing
%      singleton*.
%
%      H = APPROX_AOX_GUI returns the handle to a new APPROX_AOX_GUI or the handle to
%      the existing singleton*.
%
%      APPROX_AOX_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in APPROX_AOX_GUI.M with the given input arguments.
%
%      APPROX_AOX_GUI('Property','Value',...) creates a new APPROX_AOX_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Approx_AOX_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Approx_AOX_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Approx_AOX_GUI

% Last Modified by GUIDE v2.5 30-Apr-2019 14:35:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Approx_AOX_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Approx_AOX_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Approx_AOX_GUI is made visible.
function Approx_AOX_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Approx_AOX_GUI (see VARARGIN)
...
% Choose default command line output for Approx_AOX_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);
% UIWAIT makes Approx_AOX_GUI wait for user response (see UIRESUME)
...
function varargout = Approx_AOX_GUI_OutputFcn(hObject, eventdata, handles) 
